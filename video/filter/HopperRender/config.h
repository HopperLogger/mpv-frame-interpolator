...
#define AUTO_SEARCH_RADIUS_ADJUST 0 // Whether to automatically reduce/increase the number of calculation steps depending on performance (0: Disabled, 1: Enabled)
