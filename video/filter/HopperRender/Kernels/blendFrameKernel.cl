...
__kernel void blendFrameKernel(__global const unsigned short* warpedFrameArray12,
							   __global const unsigned short* warpedFrameArray21,
	...
	if (cz == 0 && cy < dimY && cx < dimX) {
        ...
        outputFrame[cy * dimX + cx] = (unsigned short)fmax(fmin((pixelValue - outputBlackLevel) / (outputWhiteLevel - outputBlackLevel) * 65535.0f, 65535.0f), 0.0f);
	// U/V Channels
